...
export function UpgradeRequired({ requiredPlan, feature }: { requiredPlan: Plan; feature: string }) {
  ...
  return (
    <Card className="max-w-[560px] text-center py-10">
      ...
      <div className="text-textSecondary text-[13.5px] mb-6">Faça upgrade da sua assinatura para desbloquear este recurso, sem perder nada do que você já tem hoje.</div>
