...
const VARIANT_CLASSES: Record<Variant, string> = {
  primary: 'bg-blue text-white hover:opacity-90 disabled:bg-onNavyDim disabled:opacity-100',
  ...
  danger: 'bg-redBg text-red border border-redBorder hover:opacity-90',
