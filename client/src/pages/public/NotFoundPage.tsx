  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center p-6 bg-bg">
      <div className="text-center max-w-[440px]">
        ...
        <div className="text-textSecondary text-[14px] mb-8 leading-relaxed">O link pode estar quebrado ou a página foi movida. Volte para a plataforma ou fale com o suporte.</div>
