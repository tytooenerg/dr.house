        ...
        {disputes.map((d) => (
          <div key={d.id} className="bg-white rounded-card p-6" style={{ border: '1px solid #E9CFCB' }}>
            ...
            <div className="flex items-center gap-2.5 flex-wrap">
              ...
              <button type="button" onClick={() => resolve(d.id)} className="px-3.5 py-2.5 rounded-lg border-none bg-green text-white text-[13px] font-bold cursor-pointer">
                Resolver — marcar aceita
              </button>
