...
import { confirmingRouter } from './routes/confirming.js';
import { confirmingFundoRouter } from './routes/confirmingFundo.js';
...
import { creditLineFundRouter } from './routes/creditLineFund.js';
...
app.use('/api/conformidade', complianceCalendarRouter);
app.use('/api/confirming', confirmingRouter);
app.use('/api/confirming-fundo', confirmingFundoRouter);
...
app.use('/api/credit-line', creditLineRouter);
