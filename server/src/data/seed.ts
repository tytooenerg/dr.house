...
export const ROLE_TABS: Record<'investidor' | 'cedente' | 'sacado' | 'admin' | 'seguradora' | 'auditor' | 'api_partner' | 'anunciante', string[]> = {
  ...
  cedente: ['dashboard', 'erp', 'emitir', 'minhas', 'linha-credito', 'contas-pagar', 'ai-cfo', 'fiscal', 'aceite', 'risco', 'historico', 'compliance', 'dev', 'conta', 'receita', 'assinatura', 'disputa', 'perfil'],
